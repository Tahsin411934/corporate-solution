          ...
          <div className="space-y-4">
           <div className="flex items-center">
              <Image
                ...
                width={250}
                height={150}
                className=" rounded-3xl border border-e-amber-200"
              />
            </div>
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/share/1Ad1femrZ5/" className="text-gray-300 hover:text-white transition-colors">
