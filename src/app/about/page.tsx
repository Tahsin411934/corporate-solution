    ...
    <div className="bg-gray-50 min-h-screen py-16">
      ...
      <div className="bg-white border-b border-gray-200 py-12 md:py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">About Corporate Solutions</h1>
      ...
      <div className="container mx-auto px-4 py-16 md:py-24">
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="md:w-1/2">
            <div className="bg-gray-200 h-80 md:h-96 rounded-lg overflow-hidden">
              <img 
                src="/aboutus.jpg" 
      ...
      {/* <div className="bg-gray-100 py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              A team of experienced professionals dedicated to your business success
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg overflow-hidden shadow-md">
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold">Md. Rahman</h3>
                <p className="text-blue-600 mb-3">Founder & CEO</p>
                <p className="text-gray-600 text-sm">
                  With 20+ years in business consulting, Rahman leads our strategic vision and growth initiatives.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md">
              <div className="h-64 bg-gray-300 overflow-hidden">
                <img src="/team-member2.jpg" alt="Director" className="w-full h-full object-cover" />
              </div>
              <div className="p-6">
                <h3 className="text-xl font-bold">Fatima Akter</h3>
                <p className="text-blue-600 mb-3">Director of Operations</p>
                <p className="text-gray-600 text-sm">
                  Fatima oversees service delivery with 15 years experience in operational excellence.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md">
              <div className="h-64 bg-gray-300 overflow-hidden">
                <img src="/team-member3.jpg" alt="Consultant" className="w-full h-full object-cover" />
              </div>
              <div className="p-6">
                <h3 className="text-xl font-bold">Kamal Hossain</h3>
                <p className="text-blue-600 mb-3">Senior Business Consultant</p>
                <p className="text-gray-600 text-sm">
                  Kamal specializes in market analysis and strategic planning for diverse industries.
                </p>
              </div>
            </div>
          </div>
