    ...
    <html lang="en" data-theme="white">
      <body className={`${inter.variable} ${inter.className} bg-white text-gray-900`}>
        ...
        <a
          ...
          className="fixed bottom-14 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-green-500/30 transition-transform duration-200 hover:scale-105"
        >
